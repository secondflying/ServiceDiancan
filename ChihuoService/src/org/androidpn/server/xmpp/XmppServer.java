...
public class XmppServer {
    ...
    public void start() {
        try {
            ...
            chainBuilder.addLast("executor", new ExecutorFilter());
            chainBuilder.addLast("codec", new ProtocolCodecFilter(new XmppCodecFactory()));
            acceptor.setFilterChainBuilder(chainBuilder);

            acceptor.setHandler(new org.androidpn.server.xmpp.net.XmppIoHandler());
